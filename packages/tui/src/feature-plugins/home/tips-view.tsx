...
const TIPS: Tip[] = [
  ...
  "Run {highlight}saby{/highlight} to launch the Saby copilot chat with a managed session",
  "Run {highlight}saby auth status{/highlight} to confirm your Saby session is live",
  "Renew your session at any time with {highlight}saby auth login{/highlight}",
  "Every {highlight}saby_*{/highlight} tool runs governed and audited against your tenant policy",
  "HIGH and CRITICAL Saby actions (deletes, permission changes, moves) always prompt for approval",
